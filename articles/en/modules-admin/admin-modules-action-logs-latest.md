<!-- Filename: Help4.x:Admin_Modules:_Action_Logs_-_Latest / Display title: Modules: Action Logs - Latest -->
...
![action logs latest module form](../../../images/en/modules-admin/modules-actionlogs-latest-screenshot.png "Action Logs Latest Module Form")
...
alt="action logs latest advanced tab" />
...
alt="action logs latest permissions tab" />

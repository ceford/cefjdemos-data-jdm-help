<!-- Filename: Help4.x:Menu_Item:_Article_Archived / Display title: Menus : Articles archivés -->
...
alt="Help-4x-Menus-Item-Articles-Article-Archived-screen-fr.png" />
...
alt="Help-4x-Menus-Item-Articles-Article-Archived-archive-subscreen-fr.png" />
...
alt="Help-4x-Menus-Item-Articles-Article-Archived-options-subscreen-fr.png" />
...
| <span class="mw-selflink selflink">Menus : Articles archivés</span>                                                                                                   | Shows a customised list of articles ordered by date or title. Archived articles are no longer published but are still stored on the site.                                                   |

...
inseridas na seção de informações de metadados da tela [Artigos: Novo ou
editar](https://docs.joomla.org/Help4.x:Articles:_Edit/pt-br#Guia_de_publica.C3.A7.C3.A3o "Help4.x:Articles: Edit/pt-br").

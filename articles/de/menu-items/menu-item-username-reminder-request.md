<!-- Filename: Help4.x:Menu_Item:_Username_Reminder_Request / Display title: Menüeintrag: Benutzername erneut zusenden -->
...
| Benutzer: Zugriffsebenen anzeigen und bearbeiten. Jedes Objekt der Seite ist einer Zugriffsebene zugeordnet. Benutzergruppen sind ebenfalls einer Zugriffsebene zugeordnet.Ist ein Benutzer Mitglied einer Gruppe, die der Zugriffsebene zugeordnet ist, sieht der Benutzer jedes Objekt der Zugriffsebene. Es ist hilfreich zu verstehen, dass Benutzergruppen hierarchisch in Unter-Gruppen angeordnet werden können. Dann hat eine Unter-Gruppe Zugriff auf alle Zugriffsebenen der übergeordneten Benutzergruppen. Damit müssen einer Unter-Gruppe keine Zugriffsebene zugeordnet werden, die die übergeordnete Benutzergruppe schon hat. |

<!-- Filename: Help4.x:Site_Modules:_Footer / Display title: Site Modul: Fußzeile -->

## Beschreibung

Der Modultyp **Fußzeile** zeigt typischerweise das Copyright der Website
und die Lizenzinformationen von Joomla! an.

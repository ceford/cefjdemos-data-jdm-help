<!-- Filename: Help4.x:Site_Modules:_Feed_Display / Display title: Site Modul: Externen Feed anzeigen -->

## Beschreibung

Der Modultyp **Externen Feed anzeigen** zeigt einen RSS-News-Feed von
einer Website an. Dieses Modul steht in keinem Verhältnis zur
News-Feeds-Komponente oder den News-Feeds-Layouts und ist eine
Alternative, mit der ein Feed auf einer Modulposition angezeigt werden
kann.

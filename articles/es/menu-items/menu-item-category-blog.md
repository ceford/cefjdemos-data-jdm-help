<!-- Filename: Help4.x:Menu_Item:_Category_Blog / Display title: Menús: Mostrar una categoría en formato blog -->
...
| <span class="mw-selflink selflink">Menús: Mostrar una categoría en formato blog</span>                                                                              | Used to show articles belonging to a specific Category in a blog layout. Controls the Leading Articles, Intro Articles and additional links to more Articles.                               |
